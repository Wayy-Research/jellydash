...
def upsert_jelly_detail(conn: sqlite3.Connection, detail: JellyDetail) -> None:
    ...
    cur.execute(
        ...
        (
            ...
            detail.video.hls_master if detail.video and detail.video.hls_master else None,
            detail.likes_count or 0,
            detail.comments_count or 0,
            detail.all_views or 0,
            detail.distinct_views or 0,
            detail.anon_views or 0,
            detail.tips_total or 0.0,
            detail.price,
